...
protocol TransactionConfirmationViewControllerDelegate: class {
    func transactionConfirmationDidDissmiss(in controller: TransactionConfirmationViewController)
    func controller(_ controller: TransactionConfirmationViewController, okButtonSelected sender: UIButton)
}
...
class TransactionConfirmationViewController: UIViewController {
    ...
    private func configure(viewModel: TransactionConfirmationViewModel) {
    ...
    @objc private func dissmiss(_ sender: UIBarButtonItem) {
        delegate?.transactionConfirmationDidDissmiss(in: self)
    }
